...
## Now
Task: **Group 3b Chat** — plan approved 2026-08-29 (Phase mode, 3 sub-slices in `kis/intent/Group3Plan.md`), not started. Ledger: [x] proxy (done 2026-08-29) · [ ] Chat page (next) · [ ] Task→session. Group 3a done 2026-08-29 (stop-run, templates, agents API, gateways, Agents UI).
