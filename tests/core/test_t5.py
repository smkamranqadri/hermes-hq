...
store.set_goal_status(g4, "planning", db_path=DB); store.set_goal_status(g4, "planned", db_path=DB)
...
store.set_goal_status(g6, "planning", db_path=DB); store.set_goal_status(g6, "planned", db_path=DB)
